...
function setup(){
  ...
  background2.scale = 1.5;
   ...
   gameover = createSprite(width/2,height-260,20,20);
  gameover.addImage(gameoverImg);
  
  restart = createSprite(width-290,height-210,20,20);
  ...
  bheem = createSprite(width-480,height-120,30,40);
...
function draw(){
  ...
  fill("red");
  textSize(20);
  text("score = "+score,width-410,height-405);
  text("life = "+life,width-140,height-404);
...
function spawnLadoos(){
  if(frameCount% 80 == 0){
  var s = Math.round(random(height-250,height-210));
